...
def startbypass():
    ...
    messagebox.showinfo("Step 1", "We will now bypass your device")
    ...
    # boot IPSW
    print("Booting SSHRD...")
    os.system("palera1n -f")  # +str(LAST_CONNECTED_IOS_VER))
    print("Booted SSHRD!\n")
    # wait 10 seconds
    time.sleep(10)
    # starting bypass
...
cButton6 = tk.Button(frame,
                   ...
                   state="normal")
cButton6.place(x=15, y=160)
cButton7 = tk.Button(frame,
                   text="bypass(rootless)",
                   command=startbypassrootless,
                   state="normal")
cButton7.place(x=200, y=10)
